...
let handler = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    ...
    const domain = 'https://mypanel.lyeeid.my.id'
...
> Perintah :\n${usedPrefix + command} nomor/tag`);
            ...
            let dms = '6289515827310@s.whatsapp.net';
...
✅Toko : LyeeHost Store`,})
        ...
        case 'listusr': {
            ...
            await conn.sendMessage(m.chat, {
                text: "Berikut list user *LYEEHOST PANEL*",
...
⛔EXPIRED : 1 Bulan`)
        ...
        case 'listsrv': {
            ...
            await conn.sendMessage(m.chat, {
                text: "Berikut list server *LYEEHOST PANEL*",
                footer: `Page: ${res.meta.pagination.current_page}/${res.meta.pagination.total_pages}`,
                title: "*LYEEHOST PANEL*",
